 ...
 */
abstract class AbstractElytronDefinition extends SimpleResourceDefinition {

    /**
     *
     * @return Class loader for the resource. This usually matches the current subsystem.
     * @param <E> A server {@link Extension} sharing common components with Elytron.
     */
    abstract <E extends AbstractElytronExtension> Class<E> getExtensionClass();
    /**
     * @return Name of the subsystem the resource should be registered to. This should be used by resources which are not
     * common amongst Elytron-based subsystems.
    */
    abstract String getSubsystemName();
    static final String ELYTRON_SUBSYSTEM_NAME = "elytron";
    ...
    AbstractElytronDefinition(AtomicReference<ExpressionResolverExtension> resolverReference) {
    ...
    public void registerChildren(ManagementResourceRegistration resourceRegistration) {
        ...
        resourceRegistration.registerSubModel(new CredentialStoreResourceDefinition(getExtensionClass()));
        resourceRegistration.registerSubModel(new SecretKeyCredentialStoreDefinition(getExtensionClass()));
